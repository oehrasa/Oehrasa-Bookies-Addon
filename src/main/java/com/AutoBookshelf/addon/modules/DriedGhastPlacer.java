...
public class DriedGhastPlacer extends Module {
    ...
    private void checkIce() {
        if (mc.world.getBlockState(targetPos).getBlock() != Blocks.ICE) { delayTicks = 2; return; }
    ...
    private void checkWater() {
        if (mc.world.getBlockState(targetPos).getBlock() != Blocks.WATER) { delayTicks = 2; return; }
