...
public class MobOwner extends Module {
    ...
    private void loadCache() {
        try {
            cacheFile = new File(mc.runDirectory, "mob_owner_cache.json");
            if (cacheFile.exists()) {
    ...
    private boolean isOwnableEntity(Entity entity) {
        return entity instanceof TameableEntity || (showProjectiles.get() && entity instanceof ProjectileEntity);
    }
    ...
    private UUID getRealOwnerUuid(Entity entity) {
        ...
        if (showProjectiles.get() && entity instanceof ProjectileEntity proj) {
