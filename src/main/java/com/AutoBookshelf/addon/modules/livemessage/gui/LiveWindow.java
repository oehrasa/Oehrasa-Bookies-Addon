...
public class LiveWindow {
    ...
    public void keyTyped(char typedChar, int keyCode) {
        if (keyCode == 258 && LivemessageGui.liveWindows.size() > 1) {
            if (GLFW.glfwGetKey(this.mc.getWindow().getHandle(), 340) == 1) {
    ...
    public void handleCharInput(CharInput input) {
            ...
            if (!this.visible) {
                ...
                if (this.iconIndex >= 0) {
                    ...
                    if (this.customTexture != null) {
                        ...
                        context.drawTexture(RenderPipelines.GUI_TEXTURED, LiveWindow.ICONS_TEXTURE, iconX, iconY, texU, 0.0F, 9, 9, 45, 9, grayTint);
                    }
                }
            } else {
                ...
                if (this.iconIndex >= 0) {
                    ...
                    if (this.customTexture != null) {
                        ...
                        int texU = this.iconIndex * 9;
                        context.drawTexture(RenderPipelines.GUI_TEXTURED, LiveWindow.ICONS_TEXTURE, iconX, iconY, texU, 0.0F, 9, 9, 45, 9, GuiUtil.fade(-1));
                        if (this.iconActive) {
                            int color = this.iconColor != -1 ? this.iconColor : LiveWindow.this.primaryColor;
                            int argb = GuiUtil.fade(0xFF000000 | color & 16777215);
                            context.drawTexture(RenderPipelines.GUI_TEXTURED, LiveWindow.ICONS_TEXTURE, iconX, iconY, texU, 0.0F, 9, 9, 45, 9, argb);
                        }
                    }
