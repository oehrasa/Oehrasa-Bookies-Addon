...
public class EntityList extends HudElement {
    ...
    public void render(HudRenderer renderer) {
        ...
        for (Entity entity : MeteorClient.mc.world.getEntities()) {
            ...
            boolean isPlayer = !isRocket && !isItem && entity instanceof PlayerEntity;
            boolean isMob = !isRocket && !isItem && !isPlayer && entity instanceof MobEntity;
            boolean isProjectile = !isRocket && !isItem && !isPlayer && !isMob && entity instanceof ProjectileEntity;
